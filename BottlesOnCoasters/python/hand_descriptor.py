...
class HandDescriptor():
  ...
  def GetUr5Pose(self, handToEndEffectorOffset=0.135):
    '''TODO'''
    
    T = eye(4)
    T[0:3, 0] = self.approach
    T[0:3, 1] = self.binormal
    T[0:3, 2] = self.axis
    T[0:3, 3] = self.center - handToEndEffectorOffset * self.approach
...
def FlipDescriptor(descriptor):
  ...
  return HandDescriptor(T, descriptor.imP, descriptor.imD, descriptor.imW)
