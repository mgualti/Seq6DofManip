...
from numpy import any, arange, argmax, argmin, argsort, array, concatenate, eye, exp, hstack, linspace, \
...
class RlAgentLevelGrasp1(RlAgentLevel):

  def __init__(self, params):
    '''Initializes agent in the given environment.'''

    RlAgentLevel.__init__(self, 1, True, False, params)
